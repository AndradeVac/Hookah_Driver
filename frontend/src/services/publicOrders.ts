...
export type PublicOrderResponse = { order_id: string; order_number: number; status: string; total: string; public_token: string; payment_status: string; checkout_url: string | null; preference_id?: string | null; mercado_pago_public_key?: string | null; pix_qr_code: string | null; pix_qr_code_base64: string | null }
