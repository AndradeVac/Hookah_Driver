...
def test_create_order_uses_wallet_checkout_preference_and_returns_checkout_url(monkeypatch):
    ...
    def fake_post(url, json, headers, timeout):
        ...
        return DummyResponse({"id": "ORD_123", "checkout_url": "https://example.com/checkout", "status": "created"})
    ...
    assert captured["json"]["processing_mode"] == "aggregator"
    assert captured["json"]["payment_source_id"] == "WALLET"
